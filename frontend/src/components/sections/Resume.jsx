...
const SKILLS_PREVIEW = [
    ...
    { icon: <FaReact />, name: "Kotlin", color: "#38bdf8" },
    { icon: <FaNodeJs />, name: "Android", color: "#4ade80" },
                    ...
                    <div style={{ display: "grid", gridTemplateColumns: isMobile ? "1fr" : "1fr 300px", gap: 28, alignItems: "start" }}>
                        ...
                        >
                            ...
                            <div style={{
                                ...
                                {[
                                    { role: "Android Dev Intern", company: "FinTradify", period: "Jun 2025 – Jan 2026", color: "#a3e635", dot: true },
                                    { role: "CSI Associate Lead", company: "VIT-AP", period: "2024 – Present", color: "#38bdf8", dot: false },
                                ].map((e, i) => (
                            ...
                            <div style={{
                                ...
                                {[
                                    { name: "Spring Boot Development", issuer: "Udemy" },
                                    { name: "Android App Development", issuer: "Neat Roots" },
                            ...
                            <div style={{
                                ...
                                {[
                                    { icon: <FaGithub size={16} />, href: "https://github.com/Harsh181507", label: "GitHub", color: "#f8fafc" },
                                    { icon: <FaLinkedin size={16} />, href: "https://www.linkedin.com/in/kumar-harsh-raj/", label: "LinkedIn", color: "#38bdf8" },
                                ].map((s) => (
                                    <motion.a
                                        key={s.label}
                                        href={s.href}
