...
import {
    ...
    FaAndroid, FaDocker, FaAws, FaJava,
} from "react-icons/fa";
import {
    SiSpringboot, SiPostgresql, SiKotlin, SiFirebase,
} from "react-icons/si";
...
function TechOrbit() {
    const techs = [
        ...
        { icon: <FaAndroid />, color: "#4ade80", label: "Android" },
        { icon: <SiKotlin />, color: "#818cf8", label: "Kotlin" },
...
function SocialBtn({ icon, href, label }) {
    ...
    return (
        <motion.a
            href={href} target={isMailto ? "_self" : "_blank"} rel="noopener noreferrer"
            title={label}
            style={{
      ...
      `}</style>
                ...
                <section id="home" style={{
                    ...
                    {!isMobile && (
                        <>
                            ...
                            <FloatingPill icon={<FaAndroid />} label="Android" color="#4ade80" style={{ top: "28%", right: "3%" }} delay={1.5} />
                    ...
                    <div style={{ maxWidth: 900, width: "100%", position: "relative", zIndex: 1 }}>
                        <div style={{
                            ...
                            <div>
                                ...
                                >
                                    <span style={{ color: "#a3e635" }}>harshraj@dev</span>
                                ...
                                <motion.p
                                    ...
                                    transition={{ delay: 1 }}
                                >
                                    CS student at VIT-AP & former Android Intern at FinTradify. Built production
                                    apps shipped to the Google Play Store using Kotlin & Jetpack Compose, and
                                    scalable backend systems with Spring Boot. I ship clean code, fast.
                                </motion.p>
                                ...
                                >
                                    {[
                                        ...
                                        { label: "Spring Boot", color: "#38bdf8" },
                                        { label: "Kotlin", color: "#a3e635" },
                                ...
                                >
                                    ...
                                    <motion.a
                                        href="mailto:dev.kumarharshraj@gmail.com"
                                        style={{
                                            display: "inline-flex", alignItems: "center", gap: 8,
                                ...
                                >
                                    <SocialBtn icon={<FaGithub />} href="https://github.com/Harsh181507" label="GitHub" />
                                    <SocialBtn icon={<FaLinkedin />} href="https://www.linkedin.com/in/kumar-harsh-raj" label="LinkedIn" />
                                    <SocialBtn icon={<FaEnvelope />} href="mailto:dev.kumarharshraj@gmail.com" label="Email" />
                                </motion.div>
                            </div>
                        ...
                        <div style={{
                            ...
                            >
                                ...
                                <p style={{ fontSize: 16, color: "rgba(248,250,252,0.45)", lineHeight: 1.85, margin: "0 0 32px" }}>
                                    ...
                                    and build microservices architectures. I obsess over clean architecture,
                                    REST API design, and scalable system design.
                                </p>
                            ...
                            >
                                {[
                                    { emoji: "🎓", title: "B.Tech CSE", sub: "VIT-AP University · 2023–2027", color: "#38bdf8" },
                                    { emoji: "💼", title: "FinTradify · Android Dev Intern", sub: "Jun 2025 – Jan 2026 · Noida", color: "#a3e635" },
                                    { emoji: "📱", title: "Tomato · Hackathon", sub: "Kotlin · Jetpack Compose · Razorpay", color: "#818cf8" },
                                    { emoji: "🏥", title: "Patient Mgmt Microservices", sub: "Spring Boot · Docker · REST APIs", color: "#fb923c" },
                                    { emoji: "📜", title: "Certificate Generator", sub: "React · JavaScript · PDF Generation", color: "#4ade80" },
                                ].map((item, i) => (
                                    <motion.div
                                        key={i}
                                        style={{
        ...
        ══════════════════════════════════════════════════════════ */}
                <div style={{
                    ...
                    >
                        {[...Array(2)].map((_, ri) =>
                            ["Android Development", "Jetpack Compose", "Spring Boot", "Microservices",
                                "REST API Design", "Kotlin", "AWS", "Firebase",
                                "System Design", "Docker", "Kubernetes", "Jenkins"].map((item, i) => (
                                    <span key={`${ri}-${i}`} style={{
                            ...
                            {[
                                {
                                    ...
                                    desc: "Scalable Spring Boot microservices, RESTful APIs with layered architecture and database integration using JPA/Hibernate.",
                                    tags: ["Spring Boot", "Java", "MySQL", "REST APIs"],
                                    color: "#4ade80",
                                },
                                {
                                    icon: "📱", title: "Android Development",
                                    desc: "Modern Android applications built with Jetpack Compose, Material Design 3, and Firebase integration for seamless user experiences.",
                                    tags: ["Kotlin", "Jetpack Compose", "Firebase", "Android"],
                                    color: "#38bdf8",
                                },
                                {
                                    icon: "☁️", title: "DevOps & Cloud",
                                    desc: "Containerized deployments with Docker, CI/CD pipelines with Jenkins, and cloud infrastructure on AWS for scalable applications.",
                                    tags: ["Docker", "AWS", "Jenkins", "Git"],
                                    color: "#818cf8",
                                },
                                {
                                    icon: "🔐", title: "Authentication & Auth",
                                    desc: "Implementing secure authentication and authorization flows using industry-standard patterns and security best practices.",
                                    tags: ["Auth", "Security", "REST", "MVC"],
                                    color: "#fb923c",
                                },
                                {
                                    icon: "🗄️", title: "Database Design",
                                    desc: "Relational database schema design, JPA/Hibernate ORM, query optimization, and efficient data modeling with MySQL.",
                                    tags: ["MySQL", "JPA", "Hibernate", "DBMS"],
                                    color: "#a3e635",
                                },
                                {
                                    icon: "🧩", title: "System Design",
                                    desc: "Architecting scalable distributed systems using microservices patterns, clean architecture, and Docker containerization.",
                                    tags: ["Microservices", "Docker", "OOP", "MVC"],
                                    color: "#f87171",
                                },
                            ].map((item, i) => (
                                <motion.div
