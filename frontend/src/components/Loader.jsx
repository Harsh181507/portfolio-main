...
const BOOT_LINES = [
    ...
    { text: "Building Android UI with Jetpack Compose...", delay: 0.8, color: "#38bdf8" },
    { text: "Connecting to MySQL database...", delay: 1.2, color: "#818cf8" },
    { text: "Configuring REST API endpoints...", delay: 1.6, color: "#fb923c" },
    { text: "Deploying Docker containers...", delay: 2.0, color: "#f87171" },
                    ...
                    <div style={{ display: "flex", flexDirection: "column", alignItems: "center", gap: 40, width: "100%", maxWidth: 600, padding: "0 32px" }}>
                        ...
                        >
                            ...
                            <div style={{ overflow: "hidden", marginTop: 4 }}>
                                ...
                                >
                                    {[...Array(2)].map((_, ri) =>
                                        ["Java", "Spring Boot", "Kotlin", "Jetpack Compose", "Postman", "Docker", "MySQL", "REST APIs", "Firebase", "Android"].map((t, i) => (
                                            <span key={`${ri}-${i}`} style={{
