                    ...
                    <div style={{ display: "flex", alignItems: "center", justifyContent: "space-between", height: scrolled ? 60 : 76, transition: "height 0.3s ease" }}>
                        ...
                        <div style={{ display: "flex", alignItems: "center", gap: 4 }} className="desktop-nav">
                            ...
                            <div style={{ display: "flex", gap: 14, alignItems: "center", color: "rgba(248,250,252,0.4)", fontSize: 18 }}>
                                <MagneticIcon href="https://github.com/Harsh181507">
                                    <FaGithub />
                                </MagneticIcon>
                                <MagneticIcon href="https://www.linkedin.com/in/kumar-harsh-raj">
                                    <FaLinkedin />
                                </MagneticIcon>
                            </div>
            ...
            <AnimatePresence>
                {mobileOpen && (
                    ...
                    >
                        ...
                        >
                            <a href="https://github.com/Harsh181507" target="_blank" rel="noopener noreferrer" style={{ color: "rgba(248,250,252,0.4)", fontSize: 22 }}>
                                <FaGithub />
                            </a>
                            <a href="https://www.linkedin.com/in/kumar-harsh-raj" target="_blank" rel="noopener noreferrer" style={{ color: "rgba(248,250,252,0.4)", fontSize: 22 }}>
                                <FaLinkedin />
                            </a>
                            <a href="/resume" style={{
