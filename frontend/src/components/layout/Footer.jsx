...
import { SiSpringboot, SiKotlin, SiReact } from "react-icons/si";
...
const SOCIALS = [
    { icon: <FaGithub size={18} />, href: "https://github.com/Harsh181507", label: "GitHub" },
    { icon: <FaLinkedin size={18} />, href: "https://www.linkedin.com/in/kumar-harsh-raj", label: "LinkedIn" },
    { icon: <FaEnvelope size={18} />, href: "mailto:dev.kumarharshraj@gmail.com", label: "Email" },
];

const CONTACT_INFO = [
    { icon: <FaEnvelope size={13} />, text: "dev.kumarharshraj@gmail.com", href: "mailto:dev.kumarharshraj@gmail.com" },
    { icon: <FaPhone size={13} />, text: "+91 8102244586", href: "tel:+918102244586" },
    { icon: <FaMapMarkerAlt size={13} />, text: "Vijayawada, Andhra Pradesh", href: null },
];

const STACK_ICONS = [
    { icon: <SiKotlin size={14} />, label: "Kotlin", color: "#818cf8" },
                    ...
                    >
                        <div>
                            ...
                            <p style={{ fontSize: 15, color: "rgba(248,250,252,0.4)", lineHeight: 1.7, margin: 0, maxWidth: 480 }}>
                                I'm actively looking for internships and roles in Android development and backend engineering.
                        ...
                        <div style={{ display: "flex", flexDirection: "column", gap: 14, alignItems: isMobile ? "center" : "flex-end" }}>
                            ...
                            <motion.a
                                href="https://www.linkedin.com/in/kumar-harsh-raj"
                                target="_blank"
                        ...
                        >
                            ...
                            <div style={{ display: "flex", flexDirection: "column", gap: 10, marginBottom: 28 }}>
                                {[
                                    ...
                                    { label: "Kotlin · Jetpack Compose", color: "#38bdf8" },
                                    { label: "MySQL · Firebase", color: "#4ade80" },
                                    { label: "Docker · REST APIs", color: "#818cf8" },
                                    { label: "Android · Kotlin", color: "#a3e635" },
                                ].map((item, i) => (
                            ...
                            <div style={{
                                ...
                                <div style={{ fontSize: 14, fontWeight: 700, color: "#f8fafc" }}>Open to Opportunities</div>
                                <div style={{ fontSize: 11, color: "rgba(248,250,252,0.35)", fontFamily: "'DM Mono', monospace" }}>
                                    Android · Backend · Full Stack
                                </div>
                            </div>
                        </motion.div>
                    </div>
